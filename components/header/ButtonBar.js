        ...
        },
        {
            ...
            icon:
                <StyledBadge badgeContent={total} color={'error'} overlap="circular">
                    <IconButton aria-label="add to shopping cart" sx={{padding: '4px',color: pathName === '/cart' ? Theme.palette.primary.main : '#000'}}>
    ...
    return (
        <Box>
            <Paper
                ...
                {buttonNav.map(b => (
                    <Grid color={pathName === b.link ? Theme.palette.primary.main : '#000'}
                          key={b.id}>
